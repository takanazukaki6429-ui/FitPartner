                    ...
                    <>
                        ...
                        >
                            <CardContent className="p-6 text-center space-y-4">
                                <h3 className="text-xl font-bold">{t.roadmapComplete}</h3>
                                <p className="text-sm opacity-90">
                                    {t.ctaFrom}{getLevelDescription(currentLevel, t)}{t.ctaTo}{getLevelDescription(targetLevel, t)}{t.ctaPeriod}{periodMonths}{t.months}.<br />
                                    {t.ctaDescription}
                                </p>
                                ...
                                <Button
                                    ...
                                    onClick={() => toast.success(t.trialBooked)}
                                >
                                    {t.startFreeTrial}
                                </Button>
